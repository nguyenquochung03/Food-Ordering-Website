...
import { getUserNameByToken, loginUser, registerUser, forgotPassword, verifyToken, resetPassword, verifyForgotPassword, getAdmin, addNewAdmin, updateAdmin, deleteAdmin, getStoredHashedPassword, getUserImageByToken, updateProfileImage, resetProfileImage } from '../controllers/userController.js';
...
userRouter.post("/updateAvartar", upload.single("image"), authMiddleware, updateProfileImage)
