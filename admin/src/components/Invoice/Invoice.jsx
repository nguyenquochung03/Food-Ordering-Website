    ...
    <div ref={ref} className="order-invoice">
      ...
      <div className="order-invoice-container">
        <div className="order-invoice-information">
          <p className="order-invoice-information-title">Name</p>
          <p>
            {order.address.firstName} {order.address.lastName}
          </p>
          <p className="order-invoice-information-title">Phone Number</p>
          <p>{order.address.phone}</p>
          <p className="order-invoice-information-title">Email</p>
          <p>{order.address.email}</p>
          <p className="order-invoice-information-title">Payment method</p>
