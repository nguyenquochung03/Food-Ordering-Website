...
const NormalPagination = ({ food_list, setList, setIsLoading }) => {
    ...
    const fetchData = () => {
        try {
            ...
            const currentChunk = data.slice(currentChunkIndex * chunkSize, Math.min((currentChunkIndex + 1) * chunkSize, totalItem));
    ...
    return (
        <div className="normal-pagination-container">
            ...
            <div className='normal-pagination'>
                <div className="normal-pagination-arrow-container" onClick={onLeftArrowClick}>
                    <img className='normal-pagination-arrow-left' src={images.left_arrow} alt="Left arrow" />
                </div>
                ...
                <div className="normal-pagination-arrow-container" onClick={onRightArrowClick}>
                    <img className='normal-pagination-arrow-right' src={images.left_arrow} alt="Right arrow" />
                </div>
            </div>
        </div>
    );
