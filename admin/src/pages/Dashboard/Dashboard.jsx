...
const Dashboard = ({ url, setIsLoading, selectedMonth, setSelectedMonth, isStatistic }) => {
        ...
        <div className='dashboard'>
                ...
                <div className="dashboard-header-left">
                        ...
                        <div className="dashboard-header-left-top-income">
                            <div className="dashboard-header-left-top-this-month">
                                ...
                                <div className="dashboard-header-left-top-img-container">
                                    <img src={incomeData.percentageDifference > 0 ? images.arrow_up : images.arrow_down} alt="" />
                                    <p className='dashboard-header-arrow-up'
                                        style={{
                                            color: incomeData.percentageDifference > 0 ? "#5ca832" : "#c73241"
                                        }}>
                            ...
                            <div className="dashboard-header-left-top-last-month">
                                ...
                                <div className="dashboard-header-left-top-img-container">
                                    <img src={-1 * incomeData.percentageDifference > 0 ? images.arrow_up : images.arrow_down} alt="" />
                                    <p className='dashboard-header-arrow-down'
                                        style={{
                                            color: -1 * incomeData.percentageDifference > 0 ? "#5ca832" : "#c73241"
                                        }}
                                    >
                                        {
                    ...
                    <div className="dashboard-header-left-bottom">
                        <div className="dashboard-header-left-bottom-left">
                            <VisitStatistics setIsLoading={setIsLoading} url={url} selectedMonth={selectedMonth} />
                        </div>
                        <div className="dashboard-header-left-bottom-right">
                            <RevenueStats setIsLoading={setIsLoading} url={url} selectedMonth={selectedMonth} />
                        </div>
                    </div>
                </div>
            ...
            <div className="dashboard-order-rate-category-stistic">
                <div className="dashboard-order-rate-category-stistic-left">
                    <OrderRate setIsLoading={setIsLoading} url={url} selectedMonth={selectedMonth} />
                </div>
            ...
            <div className="dashboard-order-completed-delivered">
                <MonthlyOrderChart setIsLoading={setIsLoading} url={url} selectedMonth={selectedMonth} />
                <MonthlyOrderLineChart setIsLoading={setIsLoading} url={url} selectedMonth={selectedMonth} />
            </div>
            <CustomerReviews setIsLoading={setIsLoading} url={url} selectedMonth={selectedMonth} />
            <RecentReviews setIsLoading={setIsLoading} url={url} selectedMonth={selectedMonth} />
        </div>
    )
}
